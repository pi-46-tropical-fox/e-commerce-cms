  ...
  <div class="container">
    ...
    <div class="frame">
      ...
      <div ng-app ng-init="checked = false">
        <form @submit.prevent="addProduct" class="form-signin" name="form">
          <label>Name</label>
          <input v-model="name" class="form-styling" type="text" placeholder="Product Name" />
          <label>Category</label>
          <input v-model="category" class="form-styling" type="text" placeholder="Category" />
          <label>Stock</label>
          <input v-model="stock" class="form-styling" type="text" placeholder="Stock" />
          <label>Price</label>
          <input v-model="price" class="form-styling" type="text" placeholder="Price" />
          <label>Image Url</label>
          <input v-model="image_url" class="form-styling" type="text" placeholder="Image Url" />

          <div class="btn-animate">
            <a class="btn-signin">
              <input class="background-color: coral" type="submit" value="Add Product" />
            </a>
          </div>
        </form>
      </div>
...
export default {
  ...
  methods: {
    addProduct () {
      ...
      this.$store.dispatch('addProduct', this.payload).then((response) => {
        ...
        console.log(response, '<<<ini di form Add')
        // this.$router.push('/dashboard')
      })
    }
  }
...
.frame {
  ...
  background: linear-gradient(rgba(43, 41, 41, 0.308), rgba(26, 26, 27, 0.973)),
