      ...
      <div class="nav">
        <ul>
          <li class="signin-active">
            <a class="btn">Edit Product</a>
          </li>
        </ul>
      </div>
      <div ng-app ng-init="checked = false">
        <form @submit.prevent="editProduct" class="form-signin" name="form">
          <label>Name</label>
          <input
...
export default {
  ...
  methods: {
    editProduct () {
      console.log(this.payload, '<<masuk bosh')
      console.log(this.selectedProduct.id, '<<masuk juga bosh')
      this.$store
