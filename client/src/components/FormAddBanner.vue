    ...
    <div class="frame">
      ...
      <div ng-app ng-init="checked = false">
        <form @submit.prevent="addProduct" class="form-signin" name="form">
          ...
          <input v-model="title" class="form-styling" type="text" placeholder="Banner Url" />
          ...
          <div class="col-sm-10">
            <div class="form-check">
              <input v-model="status" class="form-check-input" type="radio" value="active" checked />
              <label class="form-check-label">Active</label>

              <input v-model="status" class="form-check-input" type="radio" value="inactive" />
          ...
          <div class="btn-animate">
            <a class="btn-signin">
              <input class="background-color: coral" type="submit" value="Add Banner" />
            </a>
          </div>
        </form>
      </div>
...
export default {
  ...
  methods: {
    addProduct() {
      this.$store.dispatch("addBanner", this.payload).then((response) => {
