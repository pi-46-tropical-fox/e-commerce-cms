      ...
      <div class="nav">
        <ul>
          <li class="signin-active">
            <a class="btn">Edit Banner</a>
          </li>
        </ul>
      </div>

      <div ng-app ng-init="checked = false">
        <form @submit.prevent="editBanner" class="form-signin" name="form">
          ...
          <input
            v-model="selectedBanner.category"
            class="form-styling"
            type="text"
          ...
          <div class="col-sm-10">
            <div class="form-check">
              <input v-model="selectedBanner.status" class="form-check-input" type="radio" value="active" />
              <label class="form-check-label">Active</label>

              <input
                v-model="selectedBanner.status"
...
export default {
  ...
  computed: {
    selectedBanner: {
      get() {
        return this.$store.state.selectedBanner;
      },
    },
    payload() {
      const data = {
        title: this.selectedBanner.title,
        status: this.selectedBanner.status,
        category: this.selectedBanner.category
      };
      this.store = data
      return data;
    },
  ...
  methods: {
    editBanner() {
        console.log(this.payload, "<payload di luar")
      this.$store
        .dispatch("editBanner", {
