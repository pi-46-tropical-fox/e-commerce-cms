...
<body class="align">
  <div class="grid">
    <form @submit.prevent="customerRegister" class="form login">
      ...
      <div class="form__field">
        <input type="submit" value="Sign Up as Customer" />
      </div>
    </form>
...
export default {
  ...
  methods: {
    customerRegister () {
      this.$store
        .dispatch('customerRegister', { email: this.email, password: this.password})
        .then(() => {
